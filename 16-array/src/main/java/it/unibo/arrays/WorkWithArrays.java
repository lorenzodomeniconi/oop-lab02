...
//javac -d bin src\........\\.\.\.\.\WorkWithArrays.java
//java -cp bin it.unibo.arrays.WorkWithArrays
class WorkWithArrays {
    ...
    static int[] evenElements(final int[] array) {
        int n = (array.length%2!=0 ? array.length/2 + 1:array.length/2 );
        int[] vet = new int[n];
        int x = 0;
        for(int i = 0; x < n; i=i+2){
            vet[x]= array[i];
            x++;
        }
        return vet;
    ...
    static int[] oddElements(final int[] array) {
        int n = (array.length%2==0 ? array.length/2:array.length/2);
        int[] vet = new int[n];
        int x = 0;
